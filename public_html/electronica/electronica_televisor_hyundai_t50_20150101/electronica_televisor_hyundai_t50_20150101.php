...
<html>
    <head>
        <title>Televisores - Hyundai 50"</title>
        <meta charset="UTF-8">
        ...
        $producto = "electronica_televisor_hyundai_t50_20150101";
        ...
        <article class="informeProducto">
            <h4>HYUNDAI 50"</h4>
                ...
                <figure style="float: left">
                    <img src="televisor_hyundai_t50_20150101.jpg" alt="producto1" height="300" width="350" title="portatil" style="float: left">
            
                 <input type="button" value="+info" onclick="mostrar()">
                <p style=" font-size: 50px; color: yellow; background-color: red; background-size: 120px auto; width: 145px; float: left;   border-radius: 50px 50px 50px 50px">600&euro;</p>
            ...
            <ul class="caracteristicasProductos">
                <li>Pantalla 	<strong>50" LED FULL HD</strong></li>
      ...
      <!-------- Productos relacionados---->
         <section class=" productosDcha">
            <article class="productos">
                   <a href="../electronica_televisor_samsung_ue48h6200_20150101/electronica_televisor_samsung_ue48h6200_20150101.html">
                    <h3>Samsung 48" SMART TV</h3>
                    </a>
                       <p class="precio">560 &euro;</p>
                       <a href="../electronica_televisor_samsung_ue48h6200_20150101/electronica_televisor_samsung_ue48h6200_20150101.html">
                       <img src="../electronica_televisor_samsung_ue48h6200_20150101/samsung_ue48h6200_48__led_3d_210_210.jpg" alt="televisor"
                            height="200" title="televisor">
                       </a>
                       <ul class="caracteristicasProductos">
                            <li>48"</li>
                            <li>FULL HD</li>
                            <li>SMART TV</li>
                        <li><a href="../electronica_televisor_samsung_ue48h6200_20150101/electronica_televisor_samsung_ue48h6200_20150101.html">+info</a></li>
                        </ul>
                </article>
             
               <article class="productos">
                    <a href="../electronica_televisor_lg_42lb630v_20150101/electronica_televisor_lg_42lb630v_20150101.html">
                 <h3>Televisor LG</h3>
                    </a>
                            ...
                            <li><a href="../electronica_televisor_lg_42lb630v_20150101/electronica_televisor_lg_42lb630v_20150101.html">+info</a></li>
                            </ul>
                </article>
         </section>
         <! PUBLICIDAD DCHA >
