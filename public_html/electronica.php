...
<html>
    ...
    <table id="secciones" summary="seccionesTienda">
        ...
        <section id="productoDestacado">
            ...
            <h2 >LG 42LB630V 42" SMART TV</h2>
            
            </a>
            <figure style="float: left">
              
               <a href="electronica/electronica_televisor_lg_42lb630v_20150101/electronica_televisor_lg_42lb630v_20150101.php">
                  <img src="electronica/electronica_televisor_lg_42lb630v_20150101/televisor_lg_42lb630v_42__led_ips_210_210.jpg" alt="producto1" height="250" title="televisorLG"/>
                </a>
            
                <a href="electronica/electronica_televisor_lg_42lb630v_20150101/electronica_televisor_lg_42lb630v_20150101.php">+info</a>
            </figure>
            <ul class="caracteristicasProductos">
                <li><h3>Caracteristicas Generales</h3></li>
                ...
                <li><strong>SMARTV LG</strong></li>
                <li>DIVX</li>
            
                <li style=" font-size: 100px; color: yellow; background-color: red; background-size: 220px auto; width: 278px; float: left;   border-radius: 50px 50px 50px 50px;"> 470&euro;</li>
            </ul>
        </section>
