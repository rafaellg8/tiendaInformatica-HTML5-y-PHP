...
<html>
    ...
    <table id="secciones" summary="seccionesTienda">
        ...
        <section id="productoDestacado">
            ...
            <h2 >HP Pavilion dv6</h2>
            </a>
            <figure style="float: left">
                <a href="portatiles/portatil_hp_pavilionDV6_20150101/portatil_hp_pavilionDV6_20150101.php">
                    <img src="portatiles/portatil_hp_pavilionDV6_20150101/imagenes/paviliondv6.jpg" alt="producto1" height="250" title="paviliondv6"></a>
            
                <a href="portatiles/portatil_hp_pavilionDV6_20150101/portatil_hp_pavilionDV6_20150101.php">+info</a>
            </figure>
            <ul class="caracteristicasProductos">
                ...
                <li style=" font-size: 100px; color: yellow; background-color: red; background-size: 220px auto; width: 278px; float: left;   border-radius: 50px 50px 50px 50px;"> 345&euro;</li>
            </ul>
        </section>
